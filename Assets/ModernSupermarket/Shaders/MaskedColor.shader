...
Shader "Standard (Masked color)"
{
	Properties
	{
		...
		[ASEBegin][Header(Main)][Space(10)]_Color("Color", Color) = (1,1,1,0)
		...
		_Mask("Mask", 2D) = "white" {}
		[ASEEnd]_BumpScale1("Mask Faloff", Range( 0.001 , 1)) = 1
	...
	SubShader
	{
		...
		Pass
		{
			...
			half4 frag ( VertexOutput IN  ) : SV_Target
			{
				...
				float3 unpack7 = UnpackNormalScale( tex2D( _BumpMap, uv_BumpMap ), _BumpScale );
				unpack7.z = lerp( 1, unpack7.z, saturate(_BumpScale) );
				
				float2 uv_OcclusionMap1 = IN.ase_texcoord7.xy * _OcclusionMap1_ST.xy + _OcclusionMap1_ST.zw;
				...
				float3 Albedo = ( lerpResult21 * tex2D( _MainTex, uv_MainTex ) ).rgb;
				float3 Normal = unpack7;
				float3 Emission = ( _EmissiveColor * tex2D( _OcclusionMap1, uv_OcclusionMap1 ) ).rgb;
				float3 Specular = 0.5;
				float Metallic = ( tex2DNode8.r * _Metallic );
				float Smoothness = ( tex2DNode8.a * _Glossiness );
				float Occlusion = 1;
				float Alpha = 1;
...
/*ASEBEGIN
Version=18800
618;73;911;552;1729.486;655.4202;3.837852;True;False
Node;AmplifyShaderEditor.SamplerNode;11;-912.8998,-123.5001;Inherit;True;Property;_Mask;Mask;12;0;Create;True;0;0;0;False;1;;False;-1;None;8239f42a2471d0242957676998d19c9f;True;0;False;white;Auto;False;Object;-1;Auto;Texture2D;8;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;6;FLOAT;0;False;7;SAMPLERSTATE;;False;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.RangedFloatNode;25;-904.6917,88.80737;Inherit;False;Property;_BumpScale1;Mask Faloff;13;0;Create;False;0;0;0;False;0;False;1;0.26;0.001;1;0;1;FLOAT;0
Node;AmplifyShaderEditor.PowerNode;24;-483.6917,55.80737;Inherit;False;False;2;0;FLOAT;0;False;1;FLOAT;1;False;1;FLOAT;0
Node;AmplifyShaderEditor.ColorNode;12;-816,-768;Inherit;False;Property;_ColorMask;Color;11;0;Create;False;0;0;0;False;3;Space(10);Header(Masked Color);Space(10);False;1,1,1,0;1,0.7062074,0.2784314,0;True;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.OneMinusNode;22;-486.6443,-48.56833;Inherit;False;1;0;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.ColorNode;9;-816,-576;Inherit;False;Property;_Color;Color;0;0;Create;False;0;0;0;False;2;Header(Main);Space(10);False;1,1,1,0;1,1,1,1;True;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.SamplerNode;5;-912,-368;Inherit;True;Property;_MainTex;Albedo;1;0;Create;False;0;0;0;False;0;False;-1;None;1a0577e2e1485e741896b450a62d4103;True;0;False;white;Auto;False;Object;-1;Auto;Texture2D;8;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;6;FLOAT;0;False;7;SAMPLERSTATE;;False;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.SamplerNode;26;-888.1126,1408;Inherit;True;Property;_OcclusionMap1;Emissive;10;0;Create;False;0;0;0;False;0;False;-1;None;None;True;0;False;white;Auto;False;Object;-1;Auto;Texture2D;8;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;6;FLOAT;0;False;7;SAMPLERSTATE;;False;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.RangedFloatNode;20;-544,1040;Inherit;False;Property;_OcclusionStrength;Occlusion Power;8;0;Create;False;0;0;0;False;0;False;0.5;0.412;0;1;0;1;FLOAT;0
Node;AmplifyShaderEditor.SamplerNode;6;-912,896;Inherit;True;Property;_OcclusionMap;Occlusion;7;0;Create;False;0;0;0;False;3;Space(10);Header(Occlusion);Space(10);False;-1;None;e99580dbc173d59479658c5a0afd59b3;True;0;False;white;Auto;False;Object;-1;Auto;Texture2D;8;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;6;FLOAT;0;False;7;SAMPLERSTATE;;False;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.RangedFloatNode;18;-544,576;Inherit;False;Property;_Metallic;Metallic Power;6;0;Create;False;0;0;0;False;0;False;1;1;0;1;0;1;FLOAT;0
Node;AmplifyShaderEditor.ColorNode;27;-800,1184;Inherit;False;Property;_EmissiveColor;Color;9;1;[HDR];Create;False;0;0;0;False;3;Space(10);Header(Emissive);Space(10);False;0,0,0,0;0,0,0,0;True;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.RangedFloatNode;14;-1209.216,318.5922;Inherit;False;Property;_BumpScale;Normal Power;3;0;Create;False;0;0;0;False;0;False;1;1;0;1;0;1;FLOAT;0
Node;AmplifyShaderEditor.SamplerNode;8;-912,512;Inherit;True;Property;_MetallicGlossMap;Metallic (R) Smoothness (A);4;0;Create;False;0;0;0;False;3;Space(10);Header(Metallic  Smoothness);Space(10);False;-1;None;4fceb0aa9ea8adc458b5bafdde57be20;True;0;False;white;Auto;False;Object;-1;Auto;Texture2D;8;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;6;FLOAT;0;False;7;SAMPLERSTATE;;False;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
WireConnection;30;3;16;0
WireConnection;30;4;15;0
ASEEND*/
//CHKSM=8D321B2FAE258A1BE8BBB2F630D993CD9092DAA9